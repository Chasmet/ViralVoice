...
function chooseRoute({ speakers, targetLanguage }) {
  ...
  // V4.0.4 : priorité à la qualité vocale. Realtime reste disponible comme
  // moteur de secours, mais le doublage normal passe par gpt-audio-1.5 avec
  // une référence audio de chaque réplique.
