...
module.exports = {
  ...
  LIPSYNC_TIMEOUT_MS: Number(process.env.LIPSYNC_TIMEOUT_MS || 25 * 60 * 1000),
  LIPSYNC_MAX_DURATION_SECONDS: Number(process.env.LIPSYNC_MAX_DURATION_SECONDS || 45),
  LIPSYNC_REQUIRED: String(process.env.LIPSYNC_REQUIRED || 'false') === 'true'
};
