...
public class LauncherActivity extends MainActivity {
    ...
    private final Runnable injectNativeRuntime = () -> {
        ...
        String script = "(function(){"
                ...
                + "load('nativeRecovery411','https://chasmet.github.io/ViralVoice/recovery-client.js?v=411&t=" + cacheBust + "');"
                + "load('nativeUpdater411','https://chasmet.github.io/ViralVoice/web-updater.js?v=411&t=" + cacheBust + "');"
                + "load('nativeAdminRepair411','https://chasmet.github.io/ViralVoice/admin-repair-v411.js?v=411&t=" + cacheBust + "');"
