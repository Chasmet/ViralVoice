...
public class LauncherActivity extends MainActivity {
    ...
    private final Runnable injectNativeRuntime = () -> {
        ...
        String script = "(function(){"
                ...
                + "load('nativeRecovery415','https://chasmet.github.io/ViralVoice/recovery-client.js?v=415&t=" + cacheBust + "');"
                + "load('nativeUpdater415','https://chasmet.github.io/ViralVoice/web-updater.js?v=415&t=" + cacheBust + "');"
                + "load('nativeAdminRepair415','https://chasmet.github.io/ViralVoice/admin-repair-v411.js?v=415&t=" + cacheBust + "');"
                + "load('nativeFileSelector415','https://chasmet.github.io/ViralVoice/file-selector-fix.js?v=415&t=" + cacheBust + "');"
