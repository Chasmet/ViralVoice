...
public class LauncherActivity extends MainActivity {
    ...
    private final Runnable injectNativeRuntime = () -> {
        ...
        String script = "(function(){"
                ...
                + "load('nativeRecovery414','https://chasmet.github.io/ViralVoice/recovery-client.js?v=414&t=" + cacheBust + "');"
                + "load('nativeUpdater414','https://chasmet.github.io/ViralVoice/web-updater.js?v=414&t=" + cacheBust + "');"
                + "load('nativeAdminRepair414','https://chasmet.github.io/ViralVoice/admin-repair-v411.js?v=414&t=" + cacheBust + "');"
